 ...
 *
 */
public class DriveForDistanceDOESNOTSTOP extends Command {
	int targetTicks;
	double speed;
	double rotation;
	...
	public DriveForDistanceDOESNOTSTOP(double feet, double speed, double rotation) {
		requires(Robot.DriveTrain);
		this.targetTicks = (int)(Math.round(feet * TICKS_PER_FOOT));
		this.speed = speed;
