 ...
 *
 */
public class AutoHopperShootRed extends CommandGroup {

    public AutoHopperShootRed() {
    	addSequential(new ResetYaw());
    	addSequential(new ShiftLowGear());
    	
    	addSequential(new DriveForDistanceManual(0.16, -0.4, 0.0));
    	addSequential(new RotateToADegreeClockwiseOnly(14, 0.5, 0.225));
...
//    	addSequential(new DriveForDistanceManual(0.0, 0.8, 0.0));
    	...
    	addSequential(new DriveForDistanceManual(1.5, 1.0, 0.0));
    	

    	addParallel(new RunIntakes());
    	addSequential(new RotateToADegreeCounterClockwiseOnly(-27, 1.0, 1.0));
